...
class CricketThreeFancy extends StatefulWidget {
// final String topString;

  const CricketThreeFancy({
    super.key,
  });

  @override
  State<CricketThreeFancy> createState() => _CricketThreeFancyState();
}
...
class _CricketThreeFancyState extends State<CricketThreeFancy> {
